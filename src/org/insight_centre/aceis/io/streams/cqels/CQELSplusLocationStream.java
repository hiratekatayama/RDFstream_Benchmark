...
public class CQELSplusLocationStream extends CQELSplusSensorStream implements Runnable {
	private static final Logger logger = LoggerFactory.getLogger(CQELSplusLocationStream.class);
	private String txtFile;
	private EventDeclaration ed;

	// private ContextualFilteringManager cfm;

	public CQELSplusLocationStream(ExecContext context, String uri, String txtFile, EventDeclaration ed) {
		super(context, uri);
