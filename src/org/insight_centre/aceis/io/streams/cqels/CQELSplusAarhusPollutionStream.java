...
public class CQELSplusAarhusPollutionStream extends CQELSplusSensorStream implements Runnable {
	...
	public static void main(String[] args) {
		try {
			...
			CQELSplusAarhusPollutionStream aps = new CQELSplusAarhusPollutionStream(null, "testuri",
	...
	public CQELSplusAarhusPollutionStream(ExecContext context, String uri, String txtFile, EventDeclaration ed)
			throws IOException {
		super(context, uri);
	...
	public CQELSplusAarhusPollutionStream(ExecContext context, String uri, String txtFile, EventDeclaration ed, Date start,
