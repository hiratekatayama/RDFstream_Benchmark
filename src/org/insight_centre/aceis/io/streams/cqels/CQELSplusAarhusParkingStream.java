...
public class CQELSplusAarhusParkingStream extends CQELSplusSensorStream {
	...
	public static void main(String[] args) {
		try {
			...
			CQELSAarhusPollutionStream aps = new CQELSAarhusPollutionStream(null, "testuri",
					"streams/AarhusPollutionData158324.stream", ed);
	...
	public CQELSplusAarhusParkingStream(CqelsplusExecContext context, String uri, String txtFile, EventDeclaration ed)
			throws IOException {
		super(context, uri);
	...
	public CQELSplusAarhusParkingStream(ExecContext context, String uri, String txtFile, EventDeclaration ed, Date start,
