...
public class CQELSplusAarhusTrafficStream extends CQELSplusSensorStream implements Runnable {
	private static final Logger logger = LoggerFactory.getLogger(CQELSplusAarhusTrafficStream.class);
	static long time1;
	...
	public CQELSplusAarhusTrafficStream(CqelsplusExecContext context, String uri, String txtFile, EventDeclaration ed)
			throws IOException {
		super(context, uri);
		String fileName = "";
	...
	public CQELSplusAarhusTrafficStream(ExecContext context, String uri, String txtFile, EventDeclaration ed, Date start,
